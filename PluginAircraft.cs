    ...
    public class EqualizerPlugin : BaseUnityPlugin
    {
        ...
        public bool IsAircraftEnabled(AircraftDefinition ac)
        {
            ...
            if (!AircraftToggles.ContainsKey(key))
            {
                ...
                AircraftToggles[key] = Config.Bind("Toggles - Aircraft", $"Equalize {dispName}", true, $"Enable or disable equalization for {dispName}.");
                
                FactionRestrictions[key] = Config.Bind("Toggles - Faction Restriction", $"{dispName} Restriction", 0, 
                ...
                EqualizeMultipliers[key] = Config.Bind("Multipliers - Aircraft", $"{dispName} Multiplier", 1.0f,
